...
export default function LoginSuccess() {
  ...
  return (
    <div className="min-h-screen bg-surface-page flex flex-col items-center justify-center p-6 font-body overflow-hidden relative">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-surface-card/40 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-brand-primary/20 rounded-full blur-[100px] pointer-events-none"></div>
