                  ...
                  {!isArchiveGroup && (
                    <div className="sticky top-[40px] z-10 bg-[#f4faff] -mx-4 px-4 py-1 flex flex-col gap-1 w-full">
                      ...
                      >
                        ...
                        <span className="text-[#304151]/40 font-body font-bold text-[11px] group-hover:text-brand-primary transition-colors uppercase">
                        ...
                        <div className="flex items-start justify-between gap-2">
                          <div className="flex items-center gap-[10px] min-w-0 flex-1">
                            <div className="bg-[#f0f7fd] drop-shadow-[0px_1px_1.5px_rgba(0,0,0,0.1),0px_1px_1px_rgba(0,0,0,0.1)] flex items-center justify-center size-[44px] rounded-full shrink-0 border border-[#b4d7f6] relative">
                              ...
                              <span className={`absolute bottom-0 right-0 w-[13px] h-[13px] rounded-full border-2 border-[#f4faff] ${player.scouted ? 'bg-[#3A8C6A]' : 'bg-status-error'}`} title={player.scouted ? 'Scouted' : 'Unscouted'} />
                            </div>
