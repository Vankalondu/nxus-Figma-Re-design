    ...
    docs: {
      description: {
        component:
          ...
          'Selected day is `bg-brand-primary text-inverse rounded-full`; today is ' +
...
export const Single: Story = {
  render: () => {
    ...
    return <Calendar mode="single" selected={date} onSelect={setDate} className="rounded-xl border border-default" />
  },
}
