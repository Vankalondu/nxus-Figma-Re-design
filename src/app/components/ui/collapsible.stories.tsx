  ...
  render: () => {
    ...
    return (
      <Collapsible open={open} onOpenChange={setOpen} className="w-[420px]">
        <CollapsibleTrigger className="flex items-center gap-2 font-heading font-bold text-[10px] uppercase tracking-widest text-muted hover:text-strong transition-colors">
          Advanced filters
          <ChevronDown size={12} className={open ? 'rotate-180 transition-transform' : 'transition-transform'} />
        </CollapsibleTrigger>
        <CollapsibleContent className="pt-4 font-body text-[12px] text-muted">
