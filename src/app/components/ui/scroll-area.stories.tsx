...
export const Horizontal: Story = {
  ...
  render: () => (
    <ScrollArea className="w-[360px] rounded-[20px] border border-border-default">
      <div className="flex gap-4 p-4">
        {Array.from({ length: 10 }, (_, i) => (
          <div key={i} className="w-[120px] h-[80px] shrink-0 rounded-[16px] bg-surface-accent flex items-center justify-center font-body text-[12px] text-text-body">
            Col {i + 1}
          </div>
        ))}
      </div>
