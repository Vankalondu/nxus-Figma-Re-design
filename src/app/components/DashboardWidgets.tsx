...
export const StatsCards = () => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-[var(--gap-grid)] mb-5 w-full shrink-0 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      {/* Card 1: Light Card */}
      <div
        className="min-w-0 rounded-[24px] p-3.5 md:p-[var(--pad-card)] flex flex-col justify-between shadow-[var(--shadow-lg)] min-h-[140px] md:h-[180px] bg-surface-card cursor-pointer hover:-translate-y-1 transition-transform border border-border-default"
        onClick={() => navigate('/players?tab=players-in-scope&filter=Missing+Video')}
      >
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-surface-accent flex items-center justify-center text-text-body">
              <Settings size={18} />
            </div>
            <h3 className="text-[10px] tracking-wider md:tracking-normal md:text-[15px] font-bold text-text-heading">Missing Videos</h3>
          </div>
          <div className="w-10 h-10 hidden sm:flex items-center justify-center text-text-body cursor-pointer hover:bg-surface-accent rounded-full transition-colors">
        ...
        <div className="mt-4">
          ...
          <div className="hidden sm:flex items-center gap-1">
            {[1, 2, 3, 4, 5, 6].map((dot, i) => (
              <div key={i} className={`w-5 h-5 rounded-full ${i < 5 ? 'bg-brand-primary' : 'border-2 border-dashed border-border-default'}`} />
            ))}
          </div>
        </div>
      </div>
      ...
      {/* Card 2: Light Card */}
      <div
        className="min-w-0 rounded-[24px] p-3.5 md:p-[var(--pad-card)] flex flex-col justify-between shadow-[var(--shadow-lg)] min-h-[140px] md:h-[180px] bg-surface-card border border-border-default cursor-pointer hover:-translate-y-1 transition-transform"
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-[10px] tracking-wider md:tracking-normal md:text-[15px] font-bold text-text-heading">Missing Match Data</h3>
          </div>
          <div className="w-10 h-10 hidden sm:flex items-center justify-center text-text-body cursor-pointer hover:bg-surface-accent rounded-full transition-colors">
            <MoreVertical size={20} />
          </div>
        ...
        <div className="mt-4">
          ...
          <div className="hidden sm:flex items-center gap-1">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((dot, i) => (
              <div key={i} className={`w-5 h-5 rounded-full ${i < 4 ? 'bg-brand-primary' : 'border-2 border-dashed border-border-default'}`} />
            ))}
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className="relative z-10 p-4 sm:p-6 h-full flex flex-col justify-between">
          <div>
            <h3 className="text-[15px] md:text-[20px] font-bold text-text-on-brand leading-tight font-heading max-w-[200px]">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:gap-3 mt-auto">
            <div className="font-heading font-extrabold text-2xl md:text-[36px] tracking-tight text-text-on-brand leading-none">14</div>
            <button className="sm:hidden w-9 h-9 rounded-full bg-brand-primary text-text-on-brand flex items-center justify-center self-end shrink-0 transition-colors">
              <ChevronRight size={18} />
            </button>
            <button className="hidden sm:flex bg-brand-primary text-text-on-brand hover:bg-brand-primary/80 font-bold text-[14px] px-5 py-2 rounded-full w-fit items-center gap-2 transition-colors ml-auto">
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-[10px] tracking-wider md:tracking-normal md:text-[15px] font-bold text-text-heading">Grade A players</h3>
          </div>
          <div className="w-10 h-10 hidden sm:flex items-center justify-center text-text-body cursor-pointer hover:bg-surface-accent rounded-full transition-colors">
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:gap-[var(--gap-grid)] mb-5 w-full shrink-0 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-[10px] tracking-wider md:tracking-normal md:text-[15px] font-bold text-text-heading leading-tight">Shortlists submitted<br />for review</h3>
          </div>
          <div className="w-10 h-10 hidden sm:flex items-center justify-center text-text-body cursor-pointer hover:bg-surface-accent rounded-full transition-colors">
            <MoreVertical size={20} />
          </div>
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-surface-card/10 flex items-center justify-center text-text-body">
              <ArrowRight size={18} />
            </div>
            <h3 className="text-[10px] tracking-wider md:tracking-normal md:text-[15px] font-bold text-text-on-brand leading-tight">Reports ready<br />for review</h3>
          </div>
          <div className="w-10 h-10 hidden sm:flex items-center justify-center text-text-body cursor-pointer hover:bg-surface-card/5 rounded-full transition-colors">
            <MoreVertical size={20} />
          </div>
        </div>

        <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:gap-3 mt-auto">
          <div className="font-heading font-extrabold text-2xl md:text-[44px] tracking-tight text-text-on-brand leading-none">18</div>
          <div className="flex flex-col sm:pb-2">
            <div className="bg-surface-card/10 text-text-on-brand text-[12px] font-extrabold px-2 py-0.5 rounded-full inline-flex items-center w-fit mb-1 border border-text-on-brand/20">
      ...
      >
        ...
        <div className="relative z-10 p-4 sm:p-6 h-full flex flex-col justify-between">
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:gap-3 mt-auto">
            <div className="font-heading font-extrabold text-2xl md:text-[36px] tracking-tight text-text-on-brand leading-none">10</div>
            <button className="sm:hidden w-9 h-9 rounded-full bg-brand-primary text-text-on-brand flex items-center justify-center self-end shrink-0 transition-colors">
              <ChevronRight size={18} />
            </button>
            <button className="hidden sm:flex bg-brand-primary text-text-on-brand hover:bg-brand-primary/80 font-bold text-[14px] px-5 py-2 rounded-full w-fit items-center gap-2 transition-colors ml-auto">
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-[10px] tracking-wider md:tracking-normal md:text-[15px] font-bold text-text-heading leading-tight">% of Grade A<br />players raised</h3>
          </div>
          <div className="w-10 h-10 hidden sm:flex items-center justify-center text-text-body cursor-pointer hover:bg-surface-accent rounded-full transition-colors">
            <ArrowUpRight size={20} />
          </div>
...
export const RegionalRankings = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4 w-full max-w-[1400px]">
      ...
      <div className="bg-surface-card border border-border-default rounded-[24px] p-6 col-span-1 shadow-[var(--shadow-lg)] relative overflow-hidden">
        <h3 className="font-heading font-bold text-[20px] text-text-heading flex items-center mb-4">
      ...
      <div className="bg-surface-card border border-border-default rounded-[24px] p-6 col-span-2 shadow-[var(--shadow-lg)] flex flex-col relative overflow-hidden">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-heading font-bold text-[20px] text-text-heading flex items-center">
        ...
        <div className="flex-1 overflow-y-auto pr-2 space-y-4">
          <div>
            <div className="text-[10px] font-bold text-text-body uppercase tracking-widest mb-2 flex items-center font-heading"><Crown size={12} className="mr-1 text-[#E8A838]" /> HEAD SCOUT</div>
            <div className="flex items-center justify-between p-4 rounded-2xl border border-border-default hover:border-brand-primary/30 transition-colors bg-surface-card">
          ...
          <div>
            <div className="flex items-center justify-between text-[10px] font-bold text-text-body uppercase tracking-widest mb-2 font-heading">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={scout.rank} className="flex items-center justify-between p-4 rounded-2xl border border-border-default hover:border-brand-primary/30 transition-colors hover:bg-surface-accent/30">
                  <div className="flex items-center space-x-4">
