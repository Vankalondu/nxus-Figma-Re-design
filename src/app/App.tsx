...
function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-surface-page">
      ...
      <h1 className="font-heading font-black text-[18px] text-heading">Page not found</h1>
...
function ErrorBoundaryPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-surface-page">
      ...
      <h1 className="font-heading font-black text-[18px] text-heading">Something went wrong</h1>
      <p className="font-body text-[14px] text-body font-medium mt-2 max-w-xs text-center">
